...
class Basic:
  def onModuleLoad(self):
    ...
    self.editor = HTMLPanel("<div id='"+self.synchID+"'</div><div id='" + self.editorHTMLID + "'></div>"+ "<textarea id='"+self.editorID+"' style='height: 272px; width: 575px;'></textarea> <div id='" + self.functionID + "'></div>")
