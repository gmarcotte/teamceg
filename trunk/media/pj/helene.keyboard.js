	...
	binding:{
		'default':function(editor) {
			return {
				...
				//'s40':		function() { editor.selection.unline(); return false; }, // changed CCI
				'38':		function() { editor.cursor.up(); return false; },
				//'s38':		function() { editor.selection.line(); return false; }, // changed CCI
				'37':		function() { editor.cursor.left(); return false; },
				's37':		function() { editor.selection.endSelect(); return false; },
				'39':		function() { editor.cursor.right(); return false; },
				's39':		function() { editor.selection.startSelect(); return false; },
        ...
        's9':   function() { editor.selection.doHighlight(); return false; },
        's13':   function() { editor.selection.doHighlight(); return false; },
