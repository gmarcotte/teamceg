...
//				debug("xhr:"+((new Date).getTime())+" state:"+r.readyState+" status:"+r.status+" statusText:"+r.statusText);
                ...
                // this is a complete hack... include for demo of two terminals on same screen
                //setotherterminal(de);
							}
							rmax=100;
						} else {
  ...
  // -- ALSO we need to make sure that they're actually talking to us, and not to someone else...
...
//			debug(s);
    ...
    // FIXES THE ALWAYS STEALING KEYPRESS PROBLEM
